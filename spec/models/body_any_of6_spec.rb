...
# Unit tests for MockServer::BodyAnyOf6
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MockServer::BodyAnyOf6 do
  let(:instance) { MockServer::BodyAnyOf6.new }

  describe 'test an instance of BodyAnyOf6' do
    it 'should create an instance of BodyAnyOf6' do
      expect(instance).to be_instance_of(MockServer::BodyAnyOf6)
    end
  end
