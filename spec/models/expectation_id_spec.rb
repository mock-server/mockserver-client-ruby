...
# Unit tests for MockServer::ExpectationId
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MockServer::ExpectationId do
  let(:instance) { MockServer::ExpectationId.new }

  describe 'test an instance of ExpectationId' do
    it 'should create an instance of ExpectationId' do
      expect(instance).to be_instance_of(MockServer::ExpectationId)
    end
  end
