...
# Unit tests for MockServer::SocketAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MockServer::SocketAddress do
  let(:instance) { MockServer::SocketAddress.new }

  describe 'test an instance of SocketAddress' do
    it 'should create an instance of SocketAddress' do
      expect(instance).to be_instance_of(MockServer::SocketAddress)
    end
  end
